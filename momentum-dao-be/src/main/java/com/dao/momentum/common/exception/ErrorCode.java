...
public enum ErrorCode {
    ...
    // 평가 오류
    EVALUATION_RESULT_NOT_FOUND("40101", "조회 가능한 평가 결과가 없습니다.", HttpStatus.NOT_FOUND),
    EVALUATION_LIST_NOT_FOUND("40102", "제출할 평가가 없습니다.", HttpStatus.NOT_FOUND),
    INVALID_REQUEST("40103", "평가 ID는 필수입니다.", HttpStatus.BAD_REQUEST),
    EVAL_ROUND_NOT_FOUND("40104", "평가 회차를 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
    EVAL_ROUND_DUPLICATE("40105", "이미 존재하는 회차 번호입니다.", HttpStatus.BAD_REQUEST),
    EVAL_ROUND_INVALID_START_DATE("40106", "시작일은 반드시 오늘 또는 이후 날짜여야 합니다.", HttpStatus.BAD_REQUEST),
    EVAL_ALREADY_SUBMITTED("40107", "이미 제출된 평가입니다.", HttpStatus.BAD_REQUEST),
    EVAL_INVALID_NOT_EXIST("40108", "요인별 점수가 존재하지 않습니다.", HttpStatus.BAD_REQUEST),
    INVALID_RESULT_REQUEST("40109", "평가 결과 ID는 필수입니다.", HttpStatus.BAD_REQUEST),
    EVALUATION_NOT_FOUND("40110", "평가 결과를 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
    EVALUATION_PROMPT_NOT_FOUND("40111", "해당 양식의 문항 정보를 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
    EVALUATION_TYPE_NOT_FOUND("40112", "평가 타입 정보를 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
    EVALUATOR_ROLE_NOT_FOUND("40113", "사원의 권한을 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
    EVAL_RESULT_NOT_FOUND("40114", "평가 결과를 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
    EVAL_ROUND_CREATION_FAILED("40115", "평가 회차 등록 중 오류가 발생했습니다.", HttpStatus.BAD_REQUEST),
    EVAL_ROUND_UPDATE_FAILED("40116", "평가 회차 수정 중 오류가 발생했습니다.", HttpStatus.BAD_REQUEST),
    EVAL_ROUND_DELETE_FAILED("40117", "평가 회차 삭제 중 오류가 발생했습니다.", HttpStatus.BAD_REQUEST),
    EVAL_SUBMIT_FAILED("40118", "평가 제출 중 오류가 발생했습니다.", HttpStatus.BAD_REQUEST),
    EVAL_SCORE_CALCULATION_FAILED("40119", "평가 점수 계산 중 오류가 발생했습니다.", HttpStatus.BAD_REQUEST),
    EVAL_SAVE_FAILED("40120", "평가 점수 저장 중 오류가 발생했습니다.", HttpStatus.BAD_REQUEST),
    EVAL_UPDATE_FAILED("40121", "평가 점수 갱신 중 오류가 발생했습니다.", HttpStatus.BAD_REQUEST),
    EVAL_DELETE_FAILED("40122", "평가 점수 삭제 중 오류가 발생했습니다.", HttpStatus.BAD_REQUEST),
    EVAL_SAVE_ALL_FAILED("40123", "일괄 평가 점수 저장 중 오류가 발생했습니다.", HttpStatus.BAD_REQUEST),

    // 인사 평가 오류
    HR_OBJECTIONS_NOT_FOUND("40201", "조회 가능한 인사 평가 이의제기가 없습니다.", HttpStatus.NOT_FOUND),
    MY_OBJECTIONS_NOT_FOUND("40202", "조회 가능한 인사 평가 이의제기 내역이 없습니다.", HttpStatus.NOT_FOUND),
    HR_EVALUATION_NOT_FOUND("40203", "인사 평가 세부 정보를 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
    HR_WEIGHT_NOT_FOUND("40204", "인사 평가 가중치 기준 정보를 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
    HR_RATE_NOT_FOUND("40205", "인사 평가 등급 기준 정보를 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
    HR_RATE_INVALID_SUM("40206", "등급 비율의 총합은 100이어야 합니다.", HttpStatus.BAD_REQUEST),
    HR_WEIGHT_INVALID_SUM("40207", "가중치의 총합은 100이어야 합니다.", HttpStatus.BAD_REQUEST),
    ALREADY_SUBMITTED_OBJECTION("40208", "이미 이의제기를 제출한 평가입니다.", HttpStatus.BAD_REQUEST),
    HR_OBJECTION_NOT_FOUND("40209", "이의제기를 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
    HR_OBJECTION_FORBIDDEN("40210", "본인의 이의제기만 삭제할 수 있습니다.", HttpStatus.BAD_REQUEST),
    HR_OBJECTION_CANNOT_DELETE("40211", "대기 상태의 이의제기만 삭제할 수 있습니다.", HttpStatus.BAD_REQUEST),
    HR_OBJECTION_CANNOT_MODIFY("40212", "이미 처리된 이의제기는 수정할 수 없습니다.", HttpStatus.BAD_REQUEST),
    HR_OBJECTION_NOT_FOUND2("40213", "결과 정보를 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
    HR_EVALUATION_FORBIDDEN("40214", "인사 평가 처리 권한이 없습니다.", HttpStatus.NOT_FOUND),
    HR_EVALUATIONS_NOT_FOUND("40215", "HR 평가 내역을 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
    RATE_INFO_NOT_FOUND("40216", "등급 정보를 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
    WEIGHT_INFO_NOT_FOUND("40217", "가중치 정보를 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
    FACTOR_SCORES_NOT_FOUND("40218", "요인 점수를 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
    INVALID_ROUND_NO("40219", "유효하지 않은 회차 번호입니다.", HttpStatus.BAD_REQUEST),
    NO_EVALUATION_ROUND_FOUND("40220", "사용 가능한 평가 회차를 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
