...
class EvalResponseServiceImplTest {
    ...
    @Nested
    @DisplayName("평가 결과 저장 (Save Evaluation Result)")
    class SaveEvaluationResult {
        ...
        void saveResponse_success_withoutTargetId() {
            Long empId = 1001L;
            EvalSubmitRequest request = EvalSubmitRequest.builder()
                    .roundId(1)
                    .formId(4)
                    .targetId(2002L)
                    .reason("테스트 사유")
    ...
    @Nested
    @DisplayName("평가 결과 수정 (Update Evaluation Result)")
    ...
    @Nested
    @DisplayName("RoundId 조회 (RoundId Lookup by ResultId)")
    class RoundIdLookup {
