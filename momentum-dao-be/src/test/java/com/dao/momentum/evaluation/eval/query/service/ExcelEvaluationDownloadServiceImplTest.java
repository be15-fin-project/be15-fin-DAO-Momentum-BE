...
class ExcelEvaluationDownloadServiceImplTest {
    ...
    @Nested
    @DisplayName("사원 간 평가 엑셀 다운로드 (Peer Evaluation Excel Download)")
    class PeerEvaluationExcelDownload {

        @Test
        @DisplayName("사원 간 평가 엑셀 다운로드 - 성공 케이스")
        void downloadPeerEvaluationExcel_success() {
            // given
            PeerEvaluationExcelRequestDto request = PeerEvaluationExcelRequestDto.builder()
                    .roundId(3L)
    ...
    @Nested
    @DisplayName("조직 평가 엑셀 다운로드 (Org Evaluation Excel Download)")
    class OrgEvaluationExcelDownload {
    ...
    @Nested
    @DisplayName("자가 평가 엑셀 다운로드 (Self Evaluation Excel Download)")
    class SelfEvaluationExcelDownload {

        @Test
        @DisplayName("자가 평가 엑셀 다운로드 - 성공")
        void downloadSelfEvaluationExcel_success() {
            // given
            SelfEvaluationExcelRequestDto request = SelfEvaluationExcelRequestDto.builder()
                    .roundId(3L)
                    .empNo("20240001")
                    .deptId(10L)
                    .positionId(5L)
